...
func main() {
	...
	for _, idlFilepath := range filenames {
		...
		for _, file := range files {
			...
			file.File.HeaderComment("Code generated by https://github.com/alivers/solana-anchor-go. DO NOT EDIT.")
			{
				// Save assets:
...
`))
	...
	refedByAccount := make(map[string]bool)
	refedByEvent := make(map[string]bool)
